  ...
  if (status === 'Inactive') {
    ...
    return (
      <iframe
        ...
        src={`https://smartcitylivinglab.iiit.ac.in/grafana/d/maintenance-smartroom-aq/smart-room-aq?kiosk&var-nodeid=${item}&orgId=1`}
        width="100%"
...
return (
  <div style={{ maxWidth: '95%', margin: '0 auto' }}>
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
      <h1 style={{ color: '#fff', padding: '50px 20px 0px 0px' }}>Smart Rooms Air Quality</h1>
      <select
